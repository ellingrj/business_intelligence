# ISA 401 Airbnb Listings Explorer
...
n_occupations <- length(unique(oews$host_id))
n_areas       <- length(unique(oews$name))
data_period   <- "Sept 2024-2025"
...
qc <- querychat::querychat(
  oews,
  client = client,
  greeting = "Welcome to Our ISA 401 Assistant for Understanding Columbus Airbnb Listings",
...
ui <- bslib::page_navbar(
  id = "navbar",
  title = "Columbus Airbnb Listing Explorer",
  ...
  sidebar = bslib::sidebar(
    ...
    shiny::conditionalPanel(
      ...
      tags$div(
        ...
        tags$ul(
          tags$li("Show me the highest rated listings in the last 6 months"),
          tags$li("Filter to include only listings with licenses"),
          tags$li("What are private rooms listings under $150 a night")
        )
      )
    ),
    fillable = TRUE
  ...
  bslib::nav_panel(
    ...
    bslib::card(
      ...
      bslib::card_body(
        ...
        tags$p(
          ...
          "Explore Columbus Airbnb listings from the last 12 months as of 26 Sept, 2025 using natural language queries powered by AI"
        ),
    ...
    bslib::layout_column_wrap(
      ...
      bslib::value_box(
        title = "Data Period",
        value = data_period,
        p(format(n_occupations, big.mark = ","), " hosts \u00B7 ",
          format(n_areas, big.mark = ","), " listings"),
      ...
      bslib::card(
        ...
        bslib::card_body(
          tags$p(
            ...
            tags$strong("Sept 2025 Columbus Airbnb"),
            " dataset from the ",
          ...
          tags$div(
            ...
            tags$a(class = "btn btn-outline-primary btn-sm",
                   href = "https://data.insideairbnb.com/united-states/oh/columbus/2025-09-26/visualisations/listings.csv",
                   target = "_blank",
